//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/sdksamples/customdatalink/CusDtLnkLinkResourceStatePacket.h $
//  
...
#pragma once
#ifndef __CusDtLnkLinkResourceStatePacket__
#define __CusDtLnkLinkResourceStatePacket__
...
/**
	Class used to contain information about a link resource
	...
	@see URI
*/
class CusDtLnkLinkResourceStatePacket : public AsyncWorkPacket
{
public:
	/**
	 Default constructor.
	 Constructs a CusDtLnkLinkResourceStatePacket object.
	 ...
	 */
	CusDtLnkLinkResourceStatePacket(ILinkManager::OperationType opType,
							bool bNotify,
							IDataBase* db,
							const UID& uid,
							const URI& uri,
	...
	/**
	 Destructor.
	 Destroys the CusDtLnkLinkResourceStatePacket object.
	 */
	virtual ~CusDtLnkLinkResourceStatePacket();

	/**
	 Equality operator.
	 Test whether this CusDtLnkLinkResourceStatePacket is equal to the given CusDtLnkLinkResourceStatePacket.
	 @param rhs	[IN] CusDtLnkLinkResourceStatePacket to test for equality against this CusDtLnkLinkResourceStatePacket.
	 @return True if this CusDtLnkLinkResourceStatePacket is equal to the given CusDtLnkLinkResourceStatePacket, else false.
	 */
...
//	CusDtLnkLinkResourceStatePacket(const CusDtLnkLinkResourceStatePacket&);
//	CusDtLnkLinkResourceStatePacket& operator=(const CusDtLnkLinkResourceStatePacket&);
...
#endif	// __CusDtLnkLinkResourceStatePacket__
