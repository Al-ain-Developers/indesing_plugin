//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/sdksamples/common/SDKLayoutHelper.h $
//  
...
class SDKLayoutHelper {
	...
	public:
		...
		/**	Create a document but without opening a layout view onto it.
			...
			@param pageBinding IN 0 for left to right page binding
	...
	public:
		...
		/** Create a text frame of specified dimensions.
			...
			@param isLeftToRight IN kTrue to make frame left to right
