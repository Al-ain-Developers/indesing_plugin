//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/sdksamples/wlistboxcomposite/WLBCmpID.h $
//  
...
// Plug-in:
#define kWLBCmpPluginName	"WListBoxComposite"			// Name of this plug-in.
#define kWLBCmpPrefixNumber	0x57240 					// Unique prefix number for this plug-in(*Must* be obtained from Adobe Developer Support).
#define kWLBCmpVersion		kSDKDefPluginVersionString						// Version of this plug-in (for the About Box).
#define kWLBCmpAuthor		"Adobe Developer Technologies"				// Author of this plug-in (for the About Box).
