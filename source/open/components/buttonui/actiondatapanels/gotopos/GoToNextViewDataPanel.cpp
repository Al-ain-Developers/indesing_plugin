//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/open/components/buttonui/actiondatapanels/gotopos/GoToNextViewDataPanel.cpp $
//  
//  Owner: Steve Dowd
//  
//  $Author: pmbuilder $
...
//========================================================================================
// CLASS GoToNextViewDataPanel
//========================================================================================

class GoToNextViewDataPanel : public CPMUnknown<IBehaviorDataPanel>
{
public:
	GoToNextViewDataPanel(IPMUnknown *boss);
	virtual ~GoToNextViewDataPanel();

	virtual IPMUnknown* CreatePanel(const PMLocaleId& localeId, const PMIID& iid) const;
};	

//========================================================================================
// METHODS GoToNextViewDataPanel
//========================================================================================

CREATE_PMINTERFACE(GoToNextViewDataPanel, kGoToNextViewDataPanelImpl)

//----------------------------------------------------------------------------------------
// GoToNextViewDataPanel::GoToNextViewDataPanel
//----------------------------------------------------------------------------------------

GoToNextViewDataPanel::GoToNextViewDataPanel(IPMUnknown *boss) :
...
//----------------------------------------------------------------------------------------
// GoToNextViewDataPanel::CreatePanel
//----------------------------------------------------------------------------------------

IPMUnknown* GoToNextViewDataPanel::CreatePanel(const PMLocaleId& localeId, const PMIID& iid) const
{
	...
	IPMUnknown *returnVal = ::CreateObjectNoInit (::GetDataBase(GetExecutionContextSession()),
		RsrcSpec(localeId, kFormFieldUIPluginID, kViewRsrcType, kGoToNextViewPanelRsrcID),
		IID_ICONTROLVIEW,
