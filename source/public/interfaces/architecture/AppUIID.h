//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/public/interfaces/architecture/AppUIID.h $
//  
...
DECLARE_PMID(kClassIDSpace, kDocCorruptionAlertDialogBoss,        kAppUIPrefix + 236)
DECLARE_PMID(kClassIDSpace, kSuppressedUIForChinaRegionBoss, kAppUIPrefix + 237)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IDELAYEDPANELCREATIONDATA, kAppUIPrefix + 119)
DECLARE_PMID(kInterfaceIDSpace, IID_IDELAYEDPANELCREATION_IDLETASK, kAppUIPrefix + 120)
DECLARE_PMID(kInterfaceIDSpace, IID_IPANELRESTORETITLEDATA, kAppUIPrefix + 121)
DECLARE_PMID(kInterfaceIDSpace, IID_IDOCCORRUPTIONALERT_HEADING, kAppUIPrefix + 122)
DECLARE_PMID(kInterfaceIDSpace, IID_IDOCCORRUPTIONALERT_MSG, kAppUIPrefix + 123)
DECLARE_PMID(kInterfaceIDSpace, IID_IDOCCORRUPTIONALERT_FILECOLLECTMSG, kAppUIPrefix + 124)
DECLARE_PMID(kInterfaceIDSpace, IID_IUSERCANCELLEDDATA, kAppUIPrefix + 125)
DECLARE_PMID(kInterfaceIDSpace, IID_IACTIVESTORYEDITORWINDOW, kAppUIPrefix + 126)
DECLARE_PMID(kInterfaceIDSpace, IID_IFLOODGATEOBSERVER, kAppUIPrefix + 127)

DECLARE_PMID(kInterfaceIDSpace, IID_IUXPCONTROLLER, kAppUIPrefix + 128)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPCLIENTHELPER, kAppUIPrefix + 129)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPHELPERUTILS, kAppUIPrefix+130)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPHOMESCREENUTILS, kAppUIPrefix+131)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPCDOCLIENTHELPER, kAppUIPrefix+132)
DECLARE_PMID(kInterfaceIDSpace, IID_IPRIVATEDOCUMENTUIUTILS, kAppUIPrefix+133)
...
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertDialogWidgetID, kAppUIPrefix2 + 7)
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertLearnMoreURLTextWidgetID, kAppUIPrefix2 + 8)
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertHeadingTextWidgetID, kAppUIPrefix2 + 9)
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertMessageTextWidgetID, kAppUIPrefix2 + 10)
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertFileCollectionTextWidgetID, kAppUIPrefix2 + 11)
DECLARE_PMID(kWidgetIDSpace, kDocCorruptionAlertIconWidgetID, kAppUIPrefix2 + 12)
DECLARE_PMID(kWidgetIDSpace, kBGUITaskProgressbarWidgetID, kAppUIPrefix2 + 13)
...
DECLARE_PMID(kImplementationIDSpace, kDelayedPanelCreationDataImpl, kAppUIPrefix2 + 124)
DECLARE_PMID(kImplementationIDSpace, kDelayedPanelCreationIdleTaskImpl, kAppUIPrefix2 + 125)
DECLARE_PMID(kImplementationIDSpace, kDocCorruptionAlertDCImpl, kAppUIPrefix2 + 126)
DECLARE_PMID(kImplementationIDSpace, kDocCorruptionAlertMsgImpl, kAppUIPrefix2 + 127)
DECLARE_PMID(kImplementationIDSpace, kDocCorruptionAlertFileCollectionMsgImpl, kAppUIPrefix2 + 128)
DECLARE_PMID(kImplementationIDSpace, kActiveStoryEditorWindowImpl, kAppUIPrefix2 + 129)
DECLARE_PMID(kImplementationIDSpace, kFloodGateObserverImpl, kAppUIPrefix2 + 130)
DECLARE_PMID(kImplementationIDSpace, kUXPControllerImpl, kAppUIPrefix2 + 131)
DECLARE_PMID(kImplementationIDSpace, kUXPClientHelperImpl, kAppUIPrefix2 + 132)
DECLARE_PMID(kImplementationIDSpace, kUXPHelperUtilsImpl, kAppUIPrefix2 + 133)
DECLARE_PMID(kImplementationIDSpace, kUXPHomeScreenUtilsImpl, kAppUIPrefix2 + 134)
DECLARE_PMID(kImplementationIDSpace, kUXPCdoClientHelperImpl, kAppUIPrefix2 + 135)
DECLARE_PMID(kImplementationIDSpace, kSuppressedUIForChinaRegionImpl, kAppUIPrefix2 + 136)
DECLARE_PMID(kImplementationIDSpace, kPrivateDocumentUIUtilsImpl, kAppUIPrefix2 + 137)
...
DECLARE_PMID(kActionIDSpace, kTileAllVerticalActionID, kAppUIPrefix2 + 91)
DECLARE_PMID(kActionIDSpace, kTileAllHorizontalActionID, kAppUIPrefix2 + 92)
DECLARE_PMID(kActionIDSpace, kTile2UpVerticalActionID, kAppUIPrefix2 + 93)
DECLARE_PMID(kActionIDSpace, kTile2UpHorizontalActionID, kAppUIPrefix2 + 94)
DECLARE_PMID(kActionIDSpace, kTile3UpRightActionID, kAppUIPrefix2 + 95)
DECLARE_PMID(kActionIDSpace, kTile3UpVerticalActionID, kAppUIPrefix2 + 96)
DECLARE_PMID(kActionIDSpace, kTile3UpHorizontalActionID, kAppUIPrefix2 + 97)
DECLARE_PMID(kActionIDSpace, kTile4UpGridActionID, kAppUIPrefix2 + 98)
DECLARE_PMID(kActionIDSpace, kTile4Up2ColSplitActionID, kAppUIPrefix2 + 99)
DECLARE_PMID(kActionIDSpace, kTile4UpVerticalActionID, kAppUIPrefix2 + 100)
DECLARE_PMID(kActionIDSpace, kTile4UpHorizontalActionID, kAppUIPrefix2 + 101)
DECLARE_PMID(kActionIDSpace, kTile5Up2ColSplitActionID, kAppUIPrefix2 + 102)
DECLARE_PMID(kActionIDSpace, kTile6UpGridActionID, kAppUIPrefix2 + 103)
DECLARE_PMID(kActionIDSpace, kTile6Up3ColSplitActionID, kAppUIPrefix2 + 104)
DECLARE_PMID(kActionIDSpace, kTilingOptionsSepActionID, kAppUIPrefix2 + 105)
//
//Script Element IDs
//
