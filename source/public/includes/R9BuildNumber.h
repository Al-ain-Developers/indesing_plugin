//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/public/includes/R9BuildNumber.h $
//  
...
#ifndef __R9BuildNumber_h__
#define __R9BuildNumber_h__
...
// ----- This DOES NOT change when we have a dot release
//
#define kR9VersionNumberStr "11.4"
...
//		1. Change R9_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kR9VersionNumberForResourceStr
//		3. Update kR9VersionCopyRightStr for the Mac
//		4. Update kR9CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kR9AUMComponentVersionStr
// 
...
//
#define R9_DOT_RELEASE_NUMBER 0

#if R9_DOT_RELEASE_NUMBER
#define kR9VersionNumberForResourceStr "11.4.0"
#else
#define kR9VersionNumberForResourceStr "11.4"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kR9MajorVersionNumber RezLong(11)
#define kR9MinorVersionNumber RezLong(4)
#define kR9DotVersionNumber RezLong(R9_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kR9MajorVersionNumberForResource 11
#define kR9MinorVersionNumberForResource 4
#define kR9DotVersionNumberForResource R9_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if R9_DOT_RELEASE_NUMBER
#define kR9VersionCopyRightStr "11.4.0, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR9CFBundleVersionStr "11400"
#define kR9CRAdobeProductVersionStr "11400"
#else
#define kR9VersionCopyRightStr "11.4, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR9CFBundleVersionStr "11400"
#define kR9CRAdobeProductVersionStr "11400"
#endif
#endif
...
#ifdef WINDOWS
#define kR9VersionCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR9ShortCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated."
#endif

// ----- Version string for Adobe Update Manager managed components
#if R9_DOT_RELEASE_NUMBER
#define kR9AUMComponentVersionStr	"11.4.0."
#else
#define kR9AUMComponentVersionStr	"11.4.0."
#endif
...
#define kR9MajorScriptVersionNumber	RezLong(11)
#define kR9MinorScriptVersionNumber	RezLong(4)
