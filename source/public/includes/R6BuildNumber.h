//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/public/includes/R6BuildNumber.h $
//  
...
#ifndef __R6BuildNumber_h__
#define __R6BuildNumber_h__
...
// ----- This DOES NOT change when we have a dot release
//
#define kR6VersionNumberStr "11.1"
...
//		1. Change R6_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kR6VersionNumberForResourceStr
//		3. Update kR6VersionCopyRightStr for the Mac
//		4. Update kR6CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kR6AUMComponentVersionStr
// 
...
//
#define R6_DOT_RELEASE_NUMBER 0

#if R6_DOT_RELEASE_NUMBER
#define kR6VersionNumberForResourceStr "11.1.0"
#else
#define kR6VersionNumberForResourceStr "11.1"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kR6MajorVersionNumber RezLong(11)
#define kR6MinorVersionNumber RezLong(1)
#define kR6DotVersionNumber RezLong(R6_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kR6MajorVersionNumberForResource 11
#define kR6MinorVersionNumberForResource 1
#define kR6DotVersionNumberForResource R6_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if R6_DOT_RELEASE_NUMBER
#define kR6VersionCopyRightStr "11.1.0, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR6CFBundleVersionStr "11100"
#define kR6CRAdobeProductVersionStr "11100"
#else
#define kR6VersionCopyRightStr "11.1, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR6CFBundleVersionStr "11100"
#define kR6CRAdobeProductVersionStr "11100"
#endif
#endif
...
#ifdef WINDOWS
#define kR6VersionCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR6ShortCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated."
#endif

// ----- Version string for Adobe Update Manager managed components
#if R6_DOT_RELEASE_NUMBER
#define kR6AUMComponentVersionStr	"11.1.0."
#else
#define kR6AUMComponentVersionStr	"11.1.0."
#endif
...
// No scripting DOM changes for R6
//#define kR6MajorScriptVersionNumber	RezLong(11)
//#define kR6MinorScriptVersionNumber	RezLong(0)
