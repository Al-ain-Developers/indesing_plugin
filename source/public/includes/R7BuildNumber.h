//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/public/includes/R7BuildNumber.h $
//  
...
#ifndef __R7BuildNumber_h__
#define __R7BuildNumber_h__
...
// ----- This DOES NOT change when we have a dot release
//
#define kR7VersionNumberStr "11.2"
...
//		1. Change R7_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kR7VersionNumberForResourceStr
//		3. Update kR7VersionCopyRightStr for the Mac
//		4. Update kR7CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kR7AUMComponentVersionStr
// 
...
//
#define R7_DOT_RELEASE_NUMBER 0

#if R7_DOT_RELEASE_NUMBER
#define kR7VersionNumberForResourceStr "11.2.0"
#else
#define kR7VersionNumberForResourceStr "11.2"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kR7MajorVersionNumber RezLong(11)
#define kR7MinorVersionNumber RezLong(2)
#define kR7DotVersionNumber RezLong(R7_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kR7MajorVersionNumberForResource 11
#define kR7MinorVersionNumberForResource 2
#define kR7DotVersionNumberForResource R7_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if R7_DOT_RELEASE_NUMBER
#define kR7VersionCopyRightStr "11.2.0, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR7CFBundleVersionStr "11200"
#define kR7CRAdobeProductVersionStr "11200"
#else
#define kR7VersionCopyRightStr "11.2, Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR7CFBundleVersionStr "11200"
#define kR7CRAdobeProductVersionStr "11200"
#endif
#endif
...
#ifdef WINDOWS
#define kR7VersionCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated. All rights reserved."
#define kR7ShortCopyRightStr "Copyright 1999-2015 Adobe Systems Incorporated."
#endif

// ----- Version string for Adobe Update Manager managed components
#if R7_DOT_RELEASE_NUMBER
#define kR7AUMComponentVersionStr	"11.2.0."
#else
#define kR7AUMComponentVersionStr	"11.2.0."
#endif
...
#define kR7MajorScriptVersionNumber	RezLong(11)
#define kR7MinorScriptVersionNumber	RezLong(2)
