//========================================================================================
//  
//  $File: //depot/devtech/16.0.x/plugin/source/public/includes/CC15_1BuildNumber.h $
//  
...
#ifndef __CC15_1BuildNumber_h__
#define __CC15_1BuildNumber_h__
...
//
#define kCC15_1VersionNumber 15.1
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC15_1VersionNumberStr "15.1"
...
//		1. Change CC15_1DOT_RELEASE_NUMBER to non-zero
...
//		6. Update kCC15CRAdobeProductVersionStr similar to kCC15CFBundleVersionStr
// 
...
//
#define CC15_1DOT_RELEASE_NUMBER 0

#if CC15_1DOT_RELEASE_NUMBER
#define kCC15_1VersionNumberForResourceStr "15.1.1"
#else
#define kCC15_1VersionNumberForResourceStr "15.1"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC15_1MajorVersionNumber RezLong(15)
#define kCC15_1MinorVersionNumber RezLong(1)
#define kCC15_1DotVersionNumber RezLong(CC15_1DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC15_1MajorVersionNumberForResource 15
#define kCC15_1MinorVersionNumberForResource 1
#define kCC15_1DotVersionNumberForResource CC15_1DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC15_1DOT_RELEASE_NUMBER
#define kCC15_1VersionCopyRightStr "15.1.1, Copyright 1999-2019 Adobe Inc. All rights reserved."
#define kCC15_1CFBundleVersionStr "15100"
#else
#define kCC15_1VersionCopyRightStr "15.1, Copyright 1999-2019 Adobe Inc. All rights reserved."
#define kCC15_1CFBundleVersionStr "15100"
#endif
#endif

#ifdef WINDOWS
#define kCC15_1VersionCopyRightStr "Copyright 1999-2019 Adobe Inc. All rights reserved."
#define kCC15_1ShortCopyRightStr "Copyright 1999-2019 Adobe Inc."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC15_1DOT_RELEASE_NUMBER
#define kCC15_1AUMComponentVersionStr	"15.1.1."
#else
#define kCC15_1AUMComponentVersionStr	"15.1.0."
#endif

// ----- Version string for Adobe Crash Reporter
#if CC15_1DOT_RELEASE_NUMBER
#define kCC15_1CRAdobeProductVersionStr "15110"
#else
#define kCC15_1CRAdobeProductVersionStr "15100"
#endif
...
#define kCC15_1MajorScriptVersionNumber	RezLong(15)
#define kCC15_1MinorScriptVersionNumber	RezLong(1)
